...
public class PotatoSpecsPreferenceController extends BasePreferenceController {

    @VisibleForTesting
    static final String PROCESSOR_MODEL = "ro.soc.model";
    static String aprox;
    public PotatoSpecsPreferenceController(Context context, String preferenceKey) {
